...
FROM SRV010 SRV 
	...
	LEFT JOIN CT5060 CT5 ON SRV.RV_LCTOP = CT5.CT5_LANPAD AND CT5.D_E_L_E_T_ = '' --AND CT5.CT5_FILIAL = SRA.RA_FILIAL	
	INNER JOIN CTT060 CTT ON CTT.CTT_CUSTO = RD_CC AND CTT.D_E_L_E_T_ = '' AND CTT.CTT_FILIAL = SRA.RA_FILIAL
WHERE SRD.D_E_L_E_T_ = '' AND SRD.RD_DATARQ BETWEEN '201710' AND '201710' AND SRA.RA_FILIAL = '01'
