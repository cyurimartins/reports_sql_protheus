...
FROM SRV090 SRV  
	INNER JOIN SRD090 SRD ON SRD.RD_PD = SRV.RV_COD 
		AND SRD.D_E_L_E_T_ = ''  
	INNER JOIN SRA090 SRA ON SRD.RD_FILIAL = SRA.RA_FILIAL 
		AND SRD.RD_MAT = SRA.RA_MAT 
		AND SRA.D_E_L_E_T_ = '' 
		AND SRA.RA_FILIAL = '01'
		AND RA_CATFUNC = 'M'  -- VERIFICAR QUAIS CATEGORIAS PARA CONSIDERAR 
	LEFT JOIN CTT090 CTT ON CTT.CTT_CUSTO = SRD.RD_CC 
		--AND CTT_FILIAL = RD_FILIAL -- ADICIONAR ESSA LINHA QUERY NO ARQUIVO PRW SE EMPRESA = 0102 
		AND CTT.D_E_L_E_T_ = ''  
WHERE SRD.RD_DATPGT BETWEEN '20170901' AND '20171001'   
	AND SRV.RV_COD IN ('705', '402', '720', '496', '706', '501', '707', '552', '728') -- ADICIONAR VERBA 728
	AND SRV.D_E_L_E_T_ = ''  
